...
export function knownBrowsers() {
  ...
  switch (os.platform()) {
    ...
    case 'win32':
      return [
        { id: 'chrome',   label: 'Chrome',         devToolsPath: path.join(process.env.WEB_ACCESS_CHROME_DATA_DIR || path.join(localAppData, 'Google/Chrome/User Data'), 'DevToolsActivePort') },
